...
class TaskA2 {
    public static void main(String[] args) {
        String a = "Будь добрым, не злись, обладай терпеньем.";
        String b = "Запомни: от светлых улыбок твоих";
        String c = "Зависит не только твоё настроенье,";
        String d = "Но тысячу раз настроенье других.";
